...
(function ($) {
	var colpick = function () {
		var
			...
			show = function (ev) {
				...
				if (cal.data('colpick').disabled) return;
			...
			disable = function () {
				var cal = $('#' + $(this).data('colpickId'));
				cal.data('colpick').disabled = true;
			},
			enable = function () {
				var cal = $('#' + $(this).data('colpickId'));
				cal.data('colpick').disabled = false;
			},
	...
	$.fn.extend({
		...
		colpickDisable: colpick.disable,
		colpickEnable: colpick.enable
	});
	$.extend({
